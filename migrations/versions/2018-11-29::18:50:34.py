...
Revision ID: 413b2168d597
Revises: 
Create Date: 2018-11-29 18:50:34.861706
...
def upgrade():
    ...
    sa.Column('username', sa.String(length=64), nullable=True, server_default='NEW_USER'),
