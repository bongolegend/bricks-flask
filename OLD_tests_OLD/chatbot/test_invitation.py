...
class TestInitOnboardingInvited(BaseTestCase):
    ...
    def setUp(self):
        ...
        self.inviter = AppUser(
            phone_number=self.inviter_number, username="Jo", timezone=US_TIMEZONES["b"]
        )
        ...
        self.team = Team(founder=self.inviter, name="The Cherrys")
        ...
        self.exchange = Exchange(user=self.mitch, router=InitOnboardingInvited.__name__)
